        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="card-header">
                    <h4 class="text-danger text-bold"> Edit User
                        <a href="{{route('manage.user')}}" class="btn btn-danger btn-sm float-right">
                            <i class="far fa-hand-point-right"> </i>Manage User</a>
                    </h4>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('update.user') }}" id="editUserForm" enctype="multipart/form-data" class="form-horizontal">
                        @csrf
                        <div class="card-body">
                            <div class="form-group row">
                                <label for="name" class="col-md-4 col-form-label text-md-end">{{ __('Name') }}</label>
                                <div class="col-md-8">
                                    <input id="name" name="name" value="{{$user->name}}" type="text" class="form-control @error('name') is-invalid @enderror"   >
                                    @error('name')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input id="u_id" name="u_id" value="{{$user->id}}" type="hidden" class="form-control @error('u_id') is-invalid @enderror"   >
                                    @error('u_id')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input id="email" name="email" value="{{$user->email}}" type="email" class="form-control @error('email') is-invalid @enderror">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-8">
                                    <select id="author_name" name="author_name" class="form-select @error('author_name') is-invalid @enderror">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-8">
                                    <input id="designation" type="text" name="designation" value="{{$user->designation}}"  class="form-control @error('designation') is-invalid @enderror">
                                    @error('designation')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-8">
                                    <input id="district" name="district" type="text" value="{{$user->district}}" class="form-control @error('district') is-invalid @enderror" >
                                    @error('district')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-8">
                                    <input id="phone_number" name="phone_number" value="{{$user->phone_number}}" type="number" class="form-control @error('phone_number') is-invalid @enderror"  >
                                    @error('phone_number')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="row mb-3">
                                <label for="image" class="col-md-4 col-form-label text-md-end">{{ __('Edit Image') }}</label>
                                <div class="col-md-8">
...
<script>
    document.forms['editUserForm'].elements['status'].value = '{!! $user->status !!}';
    document.forms['editUserForm'].elements['author_name'].value = '{!! $user->auth_type !!}';
</script>
<script>
