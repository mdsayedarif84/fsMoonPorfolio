        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{!! route('update.category') !!}"  method="POST" id="editCategoryForm" class="form-horizontal" >
                            @csrf
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="hidden" name="cat_id" class="form-control form-control-user" value="{!! $category->id !!}">
                                    </div>
                                    <div class="col-sm-4"></div>
                                </div>
                                <div class="form-group row">
