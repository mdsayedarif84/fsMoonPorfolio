...
Route::middleware(['login.check'])->group(function () {
    ...
    Route::get('/unstable/{id}', [CategoryController::class, 'inactive'])->name('unstable-cat');
    Route::get('/stable/{id}', [CategoryController::class, 'active'])->name('stable-cat');
    ...
    //education
    Route::get('/education', [EducationController::class, 'index'])->name('add.education');
    //User
